...
@Service()
export class GenerateChannelHandlerService
  implements IWebSocketHandler<WebSocketGenerateChannelHandlerInput, void> {
  constructor(
  ...
  canHandle(
    message: WebSocketMessage<WebSocketGenerateChannelHandlerInput>,
  ): boolean {
