...
@Service()
export class GenerateTemplateHandlerService
  implements IWebSocketHandler<WebSocketGenerateTemplateHandlerInput, void> {
  constructor(
  ...
  canHandle(
    message: WebSocketMessage<WebSocketGenerateTemplateHandlerInput>,
  ): boolean {
